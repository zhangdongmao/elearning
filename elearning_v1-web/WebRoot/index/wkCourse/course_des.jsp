        ...
        <div class="container navContainer">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class=" headerNav active"><a href="../wkCourse/course.html">课程</a></li>
    ...
    <div class="container" style="background: white">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-8">
                        <div class="media">
                            <div class="media-left">
                                <a href="">
                                    <img src="../assets/img/course-demo-picture.jpg" class="media-object" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 ">
                        <div>
                            <a href="javasript:void(0)" class="btn btn-success btn-lg"><i class="glyphicon glyphicon-play-circle"></i>开始学习</a>
                        </div>

                        <div class="btn-group">
                            <a href="javasript:void(0)" class="btn btn-default btn-sm">
        ...
        <div class="col-md-9">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#courseOne" aria-controls="courseOne" data-toggle="tab" id="carousel">课程大纲&nbsp;<span class="badge pull-right">2</span></a></li>
                <li><a href="#testOne" aria-controls="testOne" data-toggle="tab" id="test1">测试&nbsp;<span class="badge pull-right">42</span></a></li>
                <li><a  href="#testTwo" aria-controls="testTwe" data-toggle="tab" id="test2">考试&nbsp;<span class="badge pull-right">4</span></a></li>
                <li><a href="#answer" aria-controls="answer"  data-toggle="tab" id="answer1">答疑&nbsp;<span class="badge pull-right">4</span></a></li>
                    ...
                    <div class="panel-group" id="courseOneDes">
                        <div class="panel panel-default" >
                            <div class="panel-heading" id="headingOne">
                                <h4 class="panel-title">
                                    <a href="#collapseOne" data-toggle="collapse" data-parent="#courseOneDes" aria-expanded="true" aria-controls="collapseOne">
                                        第1章 通用演示课程
                                    </a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default" >
                            <div class="panel-heading" id="headingTwo">
                                <h4 class="panel-title">
                                    <a href="#collapseTwo" data-toggle="collapse" data-parent="#courseOneDes" aria-expanded="true" aria-controls="collapseTwo">
                                        第2 章 星河湾集团演示课程
                                    </a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default" >
                            <div class="panel-heading" id="headingThree">
                                <h4 class="panel-title">
                                    <a href="#collapseThree" data-toggle="collapse" data-parent="#courseOneDes" aria-expanded="true" aria-controls="collapseThree">
                                        第3 章 壳牌石油演示课程
                                    </a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default" >
                            <div class="panel-heading" id="headingFour">
                                <h4 class="panel-title">
                                    <a href="#collapseFour" data-toggle="collapse" data-parent="#courseOneDes" aria-expanded="true" aria-controls="collapseFour">
                                        第4 章 北京任东演示课程
                                    </a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default" >
                            <div class="panel-heading" id="headingFive">
                                <h4 class="panel-title">
                                    <a href="#collapseFive" data-toggle="collapse" data-parent="#courseOneDes" aria-expanded="true" aria-controls="collapseFive">
                                        第5 章 深圳锦鸿演示课程
                                    </a>
                                </h4>
                            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <trc>
                                ...
                                <td>60</td>
                                <td>
                                    <a class="btn btn-primary btn-mini" href="#">进入</a>
                                    <a class="btn btn-default btn-mini" href="#">详情</a>
                                </td>
                            </trc>
                ...
                <div class="tab-pane" id="testTwo">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                2016-04-20 18:57 至 2017-04-01 21:57
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="teacher">
                        <a href="javascript:void(0)" class="teacher-img">
                            <img src="../assets/img/10003.jpg" alt="" class="img-circle">
                        </a>
                        <div class="teacher-name">
                            <div class="nickname"><a href="">李勇</a></div>
                            <div class="title">高级培训师</div>
                        </div>
                    </div>
                    <div class="teacher-detail">
                        <p>
                            Gopher China社区专注于Go技术领域，作为互联网技术知识的实践者和引领者，坚持一线的Go技术分享。Go技术，目前已经在Google，阿里，腾讯，360，Apple等各大公司使用，目前最流行的云计算基石Docker也是基于Go开发的。
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-body">
                    <ul class="media-list">
                        <li class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img src="../assets/img/10003.jpg" alt="" class="media-object" style="width: 50px;height: 50px">
                                </a>
                            </div>
                            <div class="media-body">
                                <label> 讲师：</label>
