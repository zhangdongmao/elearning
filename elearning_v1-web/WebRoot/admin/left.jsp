...
<body onselectstart="return false;" ondragstart="return false;"
	...
	<div style="float: left" id="my_menu" class="sdmenu">
		<div class="collapsed">
			<span>课程管理</span> <a href="<%=path %>/course/list" target="mainFrame"
				onFocus="this.blur()">课程列表</a> <a href="main_list.html"
...
>>>>>>> branch 'master' of https://github.com/zhangdongmao/elearning.git
</body>
</html>