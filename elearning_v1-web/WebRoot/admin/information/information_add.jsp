						...
						<form class="form-horizontal" id="formSave" enctype="multipart/form-data">
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-xs-6 input-group">
											<input name="title" type="text" value="" class="form-control" placeholder="">
										</div>
									</div>
									<div class="form-group">
											<label class="col-xs-1 control-label">发布时间：</label>
											<div class='col-xs-6 input-group date' id='datetimepicker1'>
												<input name="release_time" type='text' class="form-control" /> <span
											...
											<div class="row">
												...
												<div class="col-xs-6">
													<img style="width: 180px;height: 135px" id="selectImgView"
														src="<%=basePath %>upload/${infor.getPhoto()}">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-xs-6 input-group">
											<div class="row">
												<div class="col-xs-6">
													...
													<input id="selectImg" name="attachment" type="file"
														class="form-control" placeholder="0">
												</div>
												<div class="col-xs-6">
													<img style="width: 180px;height: 135px" id="selectImgView"
														src="<%=basePath %>upload/${infor.getAttachment()}">
												</div>
											</div>
										</div>
									</div>
